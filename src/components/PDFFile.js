                      ...
                      <View style={styles.boxPrice}>
                        ...
                        <View style={styles.containerAmountSix}>
                          <Text style={styles.amountquarter}>
                            ...
                            {tipo_alquiler === 'vivienda'
                              ? Math.ceil(
                                  cost * (1 - elem.seisPagos.efectivo) * 0.25
                                ).toLocaleString('es-AR')
                              : Math.ceil(
                                  comercialCost *
                      ...
                      <View style={styles.boxPrice}>
                        ...
                        <View style={styles.containerAmountSix}>
                          <Text style={styles.amount}>
                            ...
                            {tipo_alquiler === 'vivienda'
                              ? Math.ceil(
                                  (cost * 2 * (1 - elem.nuevePagos)) / 9
                                ).toLocaleString('es-AR')
                              : Math.ceil(
                                  (comercialCost * 2 * (1 - elem.nuevePagos)) /
                                    9
                                ).toLocaleString('es-AR')}
                          </Text>
                        </View>
                      ...
                      <View style={styles.boxPrice}>
                        ...
                        <View style={styles.containerAmountSix}>
                          <Text style={styles.amount}>
                            ...
                            {tipo_alquiler === 'vivienda'
                              ? Math.ceil(
                                  (cost * 2 * (1 - elem.docePagos)) / 12
                                ).toLocaleString('es-AR')
                              : Math.ceil(
                                  (comercialCost * 2 * (1 - elem.docePagos)) /
                                    12
                                ).toLocaleString('es-AR')}
                          </Text>
                        </View>
